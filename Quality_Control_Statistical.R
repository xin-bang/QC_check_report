...
args <- list(
  ...
  input5 = "./00_raw_data/240429_TPMN00173_0300_A000H75WH3-历史质检表.xlsx",
...
df5_cc_stat_final = df5_cc_stat %>% select(run,sample,tag_sample,最终评价) %>% 
...
if (nrow(sample_compare_df) > 0){
  for (i in 1:tixi_n) {
    ...
    compare_list = c( "总人内参","外源内参","目标病原RPK","原始数据","Q30")
